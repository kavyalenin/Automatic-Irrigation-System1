...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startService(new Intent(LoginActivity.this, PushNotificationService.class));
    ...
    private void attemptLogin() {
        ...
        if (GeneralMethods.replaceNull(username).equalsIgnoreCase("")) {
            cancel = true;
            focusView = mUsernameView;
            mUsernameView.setError(getString(R.string.field_required));
        } else if (GeneralMethods.replaceNull(password).equalsIgnoreCase("")) {
            cancel = true;
